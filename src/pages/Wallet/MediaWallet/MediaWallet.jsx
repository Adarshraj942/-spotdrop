  ...
  return (
    <div className='container-fluid' id='mediaWallet'>
        ...
        <div className='Walletupper' >
            <div className='flecg' style={{display:'flex',justifyContent:'space-between',margin:'10px'}}>
                <div className='flexf' style={{justifyContent:'left'}}><img style={{height:'50px'}} src={avatar} alt="" /></div>
                <div className='flexk' style={{justifyContent:'center'}}><h6>User Name</h6></div>
                <div className='flexh' style={{justifyContent:'right'}}><img src={coin} alt="" /></div>
            ...
            <div className='flecg' style={{display:'flex',justifyContent:'space-between',margin:'5px'}}>
                <div className='flexf' style={{justifyContent:'left'}}>
                   <div align='center'>
                   <div> <h6 className='head'> Pending</h6></div>
                    <div><input className='input20' type="text" /></div>
                   </div>
                </div>
                <div className='flexk' style={{justifyContent:'center'}}>
                <div align='center'>
                   <div> <h6 className='head'>Withdrawable</h6></div>
                    <div><input className='input20' type="text" /></div>
                   </div>
                    </div>
                <div className='flexh' style={{justifyContent:'right'}}>
                <div align='center'>
